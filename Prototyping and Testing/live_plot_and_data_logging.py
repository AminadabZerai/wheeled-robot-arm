...
# --- CREATE CSV FILE ---
CSV_PATH = "C:/Users/Amine/Desktop/Project_Make_it_Or_Break_It/Prototyping and Testing/DATA_LOG/CSVs/Test_X_74.csv"
        ...
        if serialArduino.in_waiting > 0:
            ...
            try:
                ...
                if ((idx % n) == 0):
                    ...
                    ax.grid(True)
                    ax.plot(time_series, angle_series, linestyle='-',linewidth=2, color='cyan', marker='o', markersize=5, markerfacecolor='yellow')  # Plot the data with a line and markers
